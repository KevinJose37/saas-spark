        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-6 text-lg text-muted-foreground">
              En TecnoAtom, somos un equipo de profesionales apasionados por la tecnología y comprometidos con el éxito de nuestros clientes. Desde 2014, hemos ayudado a más de 100 empresas a digitalizar sus operaciones y alcanzar sus objetivos de negocio.
            </p>
